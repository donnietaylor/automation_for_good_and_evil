...
- **Duration**: 15 minutes
- **Format**: PowerPoint/PDF
- **Focus**: Quick overview with 2-3 key demos
...
- Test WiFi connectivity before presenting
- Have API keys pre-loaded in environment variables
...
- `code-snippets/` - Code examples shown in slides
...
Create a handout or digital resource with:
- Link to this GitHub repository
- QR code for easy access
- List of Azure services discussed
- Recommended learning paths
- Contact information for follow-up

## Feedback

After presentations, collect feedback on:
- Which demos resonated most
